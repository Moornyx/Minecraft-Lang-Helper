...
class MainWindow(ctk.CTk):
	...
	def show_frame(self,frame):
		...
		if frame==_W:self.welcome_frame.grid(row=0,column=1,padx=(5,10),pady=10,sticky=_A);self.sidebar_button_home.configure(fg_color=_J,border_color=_N,border_width=2)
		elif frame==_d:self.mods_list_frame.grid(row=0,column=1,padx=(5,10),pady=10,sticky=_A);self.sidebar_button_mods_list.configure(fg_color=_J,border_color=_N,border_width=2)
